...
namespace ray_tracing_core::math
{
    ...
    bool Sphere::hit_distance_range(const Ray &ray, DistanceRange &hit_range) const
    {
        ...
        auto distance1 = (-b - sqrt_discriminant) / (2 * a);
        auto distance2 = (-b + sqrt_discriminant) / (2 * a);
        hit_range = { distance1, distance2 };
        return true;
    }
