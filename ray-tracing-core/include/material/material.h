...
namespace ray_tracing_core::material
{
    ...
    public:
        ...
        virtual const Material *material() const { return this; }
        virtual bool hit(const core::HitRecord &hit_record) const = 0; // hit = color.alpha > random[0, 1]
        ...
        virtual core::Color emit(const math::Ray &ray_in, const core::HitRecord &hit_record) const = 0;
