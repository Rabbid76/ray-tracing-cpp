...
namespace ray_tracing_core_unit_test
{
    namespace material
    {
        ...
        void metal_material_hit_test(void)
        {
        ...
        void metal_material_scatter_test(void)
        {
        ...
        void metal_material_scattering_pfd_test(void)
        {
        ...
        void metal_material_emitt_test(void)
        {
            auto albedo = texture::ConstantTexture(core::Color(0), 0.0f);
            auto actual_emitt = MetalMaterial(0.5, &albedo)
                    .emitt(
                            math::Ray::new_ray(math::Point3D(0), math::Vector3D(0)),
        ...
        void metal_material_has_texture_test(void)
        {
        ...
        void metal_material_has_mask_test(void)
        {
            std::vector<std::tuple<bool, texture::ConstantTexture>> test_data
                    {
