...
namespace ray_tracing_core_unit_test::material
{
    ...
    void lambertain_material_hit_test()
    {
    ...
    void lambertian_material_scatter_test()
    {
    ...
    void lambertian_material_scattering_pfd_test()
    {
    ...
    void lambertian_material_emit_test()
    {
        auto albedo = texture::ConstantTexture(core::Color(0), 0.0f);
        auto actual_emit = LambertianMaterial(&albedo)
            .emit(
                math::Ray::new_ray(math::Point3D(0), math::Vector3D(0)),
    ...
    void lambertian_material_has_texture_test()
    {
    ...
    void lambertian_material_has_mask_test()
    {
        std::vector<std::tuple<bool, texture::ConstantTexture>> test_data
        {
