...
namespace ray_tracing_utility::json
{
    ...
    private:
        ...
        ray_tracing_core::material::Material* read_isotropic_material(const rapidjson::Document::ConstObject& scene_object);
        ...
        ray_tracing_core::geometry::Geometry* read_constant_medium(const rapidjson::Document::ConstObject& scene_object);
